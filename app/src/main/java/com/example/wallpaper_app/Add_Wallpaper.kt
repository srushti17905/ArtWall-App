...
import com.example.wallpaper_app.ShowPage.shareToWhatsapp
import com.example.wallpaper_app.ui.theme.Wallpaper_AppTheme

class Add_Wallpaper : ComponentActivity() {
...
@Composable
fun Add_page(context: Context? = null) {
...
//                                shareToWhatsapp.shareImageToWhatsapp(context = this@ShowPage , image)
